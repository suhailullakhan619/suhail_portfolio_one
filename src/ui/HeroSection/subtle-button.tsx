...
export default function BorderButton() {
  ...
  return (
    <a href="https://drive.google.com/file/d/13tY473ZuUcwmjI0_elPbmlS55-hYUti6/view?usp=sharing" target="_blank" rel="noopener noreferrer">
      <button
        className='group relative border-2 flex justify-center items-center gap-3 border-white/70 rounded-full w-[9.3rem] h-12 
                   ...
                   before:absolute before:inset-0 before:bg-linear-to-r before:from-transparent 
                   before:via-white/5 before:to-transparent before:-translate-x-full 
                   hover:before:translate-x-full before:transition-transform before:duration-700 cursor-pointer mt-4'
      ...
      >
        {/* Subtle glow effect */}
        <div className='absolute inset-0 rounded-full bg-linear-to-r from-amber-200/0 via-amber-200/10 to-amber-200/0 
